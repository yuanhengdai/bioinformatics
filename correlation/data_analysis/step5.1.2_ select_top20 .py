...
#function: select the top 20 and bottom 20 correlations for each gene and save them to separate CSV files
...
output_folder = 'correlation/output_data/top20'  # 设置输出目录的路径
...
for file_path in glob.glob(os.path.join(folder_path, '*.csv')):
    ...
    # 找到相关性最大的20个
    top_20 = df.nlargest(20, 'correlation')
    
    # 找到相关性最小的20个
    bottom_20 = df.nsmallest(20, 'correlation')
    
    # 合并结果
    result = pd.concat([top_20, bottom_20])
