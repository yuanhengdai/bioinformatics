...
# 指定包含CSV文件的文件夹路径
folder_path = 'correlation/output_data/top10'  # 更改为你的文件夹路径
output_path = 'correlation/output_data/combined_top10_correlation_results.csv'  # 输出文件的路径
