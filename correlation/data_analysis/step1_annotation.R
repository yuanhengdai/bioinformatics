...
raw_file <- "raw_data/TCGA-BRCA.htseq_fpkm.tsv.gz"
TCGA_rawdata <- read_tsv(raw_file)

#设置导出的文件名和路径（禁止修改）
lncRNA_file <- "correlation/output_data/lncRNA_matrix.csv"
coding_gene_file <- "correlation/output_data/coding_gene_matrix.csv"
combined_file <- "correlation/output_data/combined_matrix.csv"
