...
file = "differential_expression/output_data/coding_gene_matrix.csv"  # 设置输入文件名
gene_category = "axon_guidance_molecules"   # 设置要筛选的基因类别 （需要修改）
final_file = "differential_expression/output_data/step2/axon_guidance_molecules_gene_matrix.csv" # 设置输出文件名（需要修改_gene_matrix.csv前面的内容）
