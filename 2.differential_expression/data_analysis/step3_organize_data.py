...
file = "differential_expression/output_data/step2/neurotrophic_factors_gene_matrix.csv"  # 设置输入文件名（可用的选项neurotrophic_factors，neurotrophic_like_factors，axon_guidance_molecules）

final_file = "differential_expression/output_data/step3/deg_neurotrophic_factors.csv" # 设置输出文件名（需要修改_gene_matrix.csv前面的内容）
