...
#设置导出的文件名和路径（禁止修改）
lncRNA_file <- "survival_analysis/output_data/lncRNA_matrix.csv"
coding_gene_file <- "survival_analysis/output_data/coding_gene_matrix.csv"
combined_file <- "survival_analysis/output_data/combined_matrix.csv"
